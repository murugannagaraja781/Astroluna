...
import com.astroluna.app.data.model.PaymentInitiateRequest
import com.astroluna.app.data.model.PaymentInitiateResponse
...
interface ApiInterface {
    ...
    suspend fun signPhonePe(@Body request: PaymentInitiateRequest): Response<com.astroluna.app.data.model.PhonePeSignResponse>
    ...
    suspend fun getUserProfile(@retrofit2.http.Path("userId") userId: String): Response<com.astroluna.app.data.model.AuthResponse>
    ...
    suspend fun getBanners(): Response<com.astroluna.app.data.model.BannerResponse>
    ...
    suspend fun getRasipalan(): Response<List<com.astroluna.app.data.model.RasipalanItem>>
