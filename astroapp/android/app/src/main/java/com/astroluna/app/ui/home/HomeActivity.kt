...
import com.astroluna.app.ui.wallet.WalletActivity
import com.astroluna.app.utils.showErrorAlert
...
import com.astroluna.app.ui.dashboard.RasiDetailDialog
...
class HomeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            val customBg = com.astroluna.app.utils.PageThemeManager.getPageColor(context, pageName, com.astroluna.app.utils.PageThemeManager.ATTR_BG, 0)
            val customCard = com.astroluna.app.utils.PageThemeManager.getPageColor(context, pageName, com.astroluna.app.utils.PageThemeManager.ATTR_CARD, 0)
            val customFont = com.astroluna.app.utils.PageThemeManager.getPageColor(context, pageName, com.astroluna.app.utils.PageThemeManager.ATTR_FONT, 0)
            val customBtn = com.astroluna.app.utils.PageThemeManager.getPageColor(context, pageName, com.astroluna.app.utils.PageThemeManager.ATTR_BUTTON, 0)

            // Dynamic Cosmic Theme
            com.astroluna.app.ui.theme.CosmicAppTheme {
                ...
                HomeScreen(
                    ...
                    isLoading = isLoading,
                    onWalletClick = {
                        startActivity(Intent(this, com.astroluna.app.ui.wallet.WalletActivity::class.java))
                    },
                    onChatClick = { astro ->
                        val intent = Intent(this, com.astroluna.app.ui.intake.IntakeActivity::class.java).apply {
                    ...
                    onRasiClick = { item ->
                        ...
                        val intent = Intent(this, com.astroluna.app.ui.rasipalan.RasipalanActivity::class.java).apply {
                    ...
                    onLogoutClick = {
                        ...
                        val intent = Intent(this, com.astroluna.app.ui.auth.LoginActivity::class.java)
                    ...
                    onDrawerItemClick = { item ->
                        when(item) {
                            ...
                            "Settings" -> {
                                startActivity(Intent(this, com.astroluna.app.ui.settings.SettingsActivity::class.java))
                            }
                            "Profile" -> {
                                startActivity(Intent(this, com.astroluna.app.ui.profile.UserProfileActivity::class.java))
                            }
                            else -> {
                                // Handle Navigation
    ...
    private fun refreshWalletBalance() {
        ...
        lifecycleScope.launch(Dispatchers.IO) {
            try {
                val response = com.astroluna.app.data.api.ApiClient.api.getUserProfile(userId)
    ...
    private fun handleServiceClick(serviceName: String) {
        when (serviceName.replace("\n", " ")) {
            "Free  horoscope" -> {
                val intent = Intent(this, com.astroluna.app.ui.horoscope.FreeHoroscopeActivity::class.java)
                startActivity(intent)
            }
            "Horoscope Match" -> {
            ...
            "Daily Horoscope" -> {
                val intent = Intent(this, com.astroluna.app.ui.rasipalan.RasipalanActivity::class.java)
                startActivity(intent)
            }
            "Astro Academy" -> {
