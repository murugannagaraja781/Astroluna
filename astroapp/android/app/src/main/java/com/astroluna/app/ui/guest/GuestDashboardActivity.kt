...
import com.astroluna.app.ui.home.ComposeRasiItem
import com.astroluna.app.ui.home.HomeScreen
...
class GuestDashboardActivity : AppCompatActivity() {
        ...
        setContent {
            CosmicAppTheme {
                ...
                if (selectedRasiItem != null) {
                   com.astroluna.app.ui.dashboard.RasiDetailDialog(
    ...
    private fun setupSocket() {
        ...
        val socket = com.astroluna.app.data.remote.SocketManager.getSocket()
        socket?.connect()
