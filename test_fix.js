...
const BASE64_SALT = "ZmE5YzhlZDUtYzI2Ni00YjUxLWJiNDAtN2VmZjRlMGU2ZmIx";
const SALT_KEY = Buffer.from(BASE64_SALT, 'base64').toString('utf-8');
const SALT_INDEX = "1";

console.log("Decoded Salt Key:", SALT_KEY);
...
async function runTests() {
    console.log("Testing PhonePe with DECODED Salt Key...\n");
